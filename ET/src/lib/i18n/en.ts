export const en = {
  ...
  landing: {
    ...
    featuresTitle: "Built for analysts",
    featuresSubtitle: "Everything you need to stay ahead of geo-economic shifts.",
    featureSourcesTitle: "Real-time source monitoring",
    featureSourcesDesc:
      "17+ curated news sources ingested via RSS every 6 hours. Reuters, BBC, Financial Times, Al Jazeera, and more.",
    featureAiTitle: "AI-powered analysis",
    featureAiDesc:
      "RAG pipeline with Claude synthesis and confidence scoring. Ask questions, get cited answers grounded in real reporting.",
    featureCitationsTitle: "Multi-source citations",
    featureCitationsDesc:
      "Pinecone vector search with reranking. Every claim is backed by inline citations you can verify.",
    featureLensesTitle: "Custom analytical lenses",
    featureLensesDesc:
      "Configure personalized topics, geographies, and perspectives. Tailor the intelligence to your focus areas.",
    howTitle: "How it works",
    howSubtitle: "From question to cited analysis in seconds.",
    howStep1Title: "Ask a question",
    howStep1Desc: "Query any geo-economic topic — tariffs, trade flows, sanctions, industrial policy.",
    howStep2Title: "AI searches & synthesizes",
    howStep2Desc: "Your question is embedded, matched against indexed articles, and synthesized by Claude.",
    howStep3Title: "Get cited analysis",
    howStep3Desc: "Receive analysis with inline citations, confidence scores, and live web results.",
    sourcesTitle: "Monitoring the world's key sources",
    ...
    statAnalysis: "Analysis engine",
    statAnalysisValue: "Claude AI",
    statCoverage: "Global coverage",
